...
This project is indexed by GitNexus as **mem0** (21872 symbols, 38672 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/mem0/context` | Codebase overview, check index freshness |
| `gitnexus://repo/mem0/clusters` | All functional areas |
| `gitnexus://repo/mem0/processes` | All execution flows |
| `gitnexus://repo/mem0/process/{name}` | Step-by-step execution trace |
